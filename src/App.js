        ...
        <Route path="/" element={<WebFrame />}>
          ...
          >
            <Route
              ...
              element={
                <ProtectedFrom Guest>
                  <Profile rol={access()} userId={userId} test={"test"} />
                </ProtectedFrom>
              }
            />
            <Route
              path="history"
              element={
                <ProtectedFrom Guest Admin Superadmin>
                  <History />
                </ProtectedFrom>
              }
            />
              ...
              element={
                <ProtectedFrom Guest User>
                  {access() === "User" ? (
                    ...
                    <Products rol={access()} adminId={userId} />
                  )}
                </ProtectedFrom>
              }
            />
            <Route
              ...
              element={
                <ProtectedFrom Guest User>
                  <CreateProduct rol={access()} adminId={userId} />
                </ProtectedFrom>
              }
            />
            <Route
