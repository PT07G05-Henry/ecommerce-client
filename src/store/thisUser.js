...
export const getThisUser = createAsyncThunk("thisUser/getThisUser", async ({user,sid}) => {
    ...
    try {
        const response = await axios.post(
            `http://${process.env.REACT_APP_DEV_API || document.domain}/users/auth0`, userToPost
        );
